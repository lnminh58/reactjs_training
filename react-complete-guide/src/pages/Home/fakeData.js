export const blogPosts = [
  {
    title: 'Iusto eaque deserunt',
    description: 'Laborum quae veniam assumenda omnis',
    ...
    replies: [
      {
        avatar:
          'https://images.unsplash.com/photo-1581790148699-c2e8ccbb8cbf?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1322&q=80',
        name: 'John',
        createdAt: 1581931300859,
        content: 'Consectetur adipisicing elit. Nulla, quaerat.'
      }
    ]
  },
  {
    title: 'Quia sunt animi nulla',
    description: 'Facilis laborum corporis',
    ...
    replies: [
      {
        avatar:
          'https://images.unsplash.com/photo-1574852859542-1b41217a7815?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80',
        name: 'Clare',
        createdAt: 1581931000859,
        content: 'Sapiente ratione enim dolores deleniti.'
      },
      {
        avatar:
          'https://images.unsplash.com/photo-1581790148699-c2e8ccbb8cbf?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1322&q=80',
        name: 'John',
        createdAt: 1581931001859,
        content: 'facilis laborum corporis odit'
      }
    ]
  },
  {
    title: 'Iusto corporis odit quaerat',
    description: 'Veniam assumenda omnis',
